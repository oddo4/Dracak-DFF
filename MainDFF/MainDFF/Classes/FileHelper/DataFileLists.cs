...
namespace MainDFF.Classes.FileHelper
{
    ...
    {
        public List<string> playerCurrentPartyIDList = new List<string>() { "01", "02", "03" };
        public List<PlayerCharacter> playerBasicData = new List<PlayerCharacter>();
        public List<CharacterStats> playerLoadedStats { get; set; }

        public List<EnemyCharacter> enemyBossData = new List<EnemyCharacter>();
        ...
        public void SetEnemyBossFiles(List<EnemyCharacter> enemyBossList)
        {
            enemyBossData = enemyBossList;
        }
