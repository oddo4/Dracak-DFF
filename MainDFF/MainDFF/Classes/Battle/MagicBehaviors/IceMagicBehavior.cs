...
{
    public class IceMagicBehavior : IAttackBehavior
    {
        ...
        {
            var attack = attacker.CharacterStats.MAGATK * attacker.CharacterStats.RESICE;
            var defense = defender.CharacterStats.MAGDEF * defender.CharacterStats.RESICE;
            ...
            else if (defender.CharacterStats.RESICE >= 2)
            {
                damage = 0;
            }
        ...
        public IceMagicBehavior()
        {
            Cost = 20;
        }
        public IceMagicBehavior(string name)
        {
            Name = name;
        }
    }
